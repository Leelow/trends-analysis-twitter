<?php
    ...
    $entete = 'Nom;Moyenne tweets/minute;Clean;Newman-Girvan;TF-IDF;SUGR;Total;Exploitable' . "\n";
    ...
    foreach($list as $campaign) {
        ...
        $line .= $time['clean'] . ';' . $time['ng'] . ';' . $time['tf_idf'] . ';' . $time['sugr'] . ';' . $time['total'] . ';' . $time['exploitable'];
